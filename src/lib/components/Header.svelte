...
<header
  class="pl-1 pr-4 pt-4 pb-3 bg-white dark:bg-gray-800 border-b border-transparent dark:border-gray-800 flex items-end justify-between shadow dark:shadow-lg"
>
  <a
    href="/"
